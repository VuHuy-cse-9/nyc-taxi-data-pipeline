...
CREATE TABLE raw_yellow_taxi (
    ...
    pickup_datetime AS TO_TIMESTAMP(payload.after.tpep_pickup_datetime.`value`, 'yyyy-MM-dd''T''HH:mm:ss.SSS'),
    dropoff_datetime AS TO_TIMESTAMP(payload.after.tpep_dropoff_datetime.`value`, 'yyyy-MM-dd''T''HH:mm:ss.SSS'),
